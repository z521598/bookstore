		...
		<table>
			<tr>
				...
				<td>
					...
					<%  Goods goods = (Goods)request.getAttribute("oneGoods");
					if(goods.getIsonsale() == 1){
					%>
					<font size = "3" color = "blue">上架中</font>
					<%}else{ %>
					<font size = "3" color = "red">已下架</font>
					<%
					} 
					%>
				</td>
			...
			<tr>
				<td colspan="2">
					...
					<font size="2" color="red">进货价格：${oneGoods.storeprice }元</font>
